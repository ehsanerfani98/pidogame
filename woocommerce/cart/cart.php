						...
						<tr>
							<td colspan="6" class="actions">
								...
								<div class="wrap-footer-cart">
									...
									<?php } ?>
									<button type="submit" class="button btn btn-info" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_html_e('Update cart', 'woocommerce'); ?></button>
