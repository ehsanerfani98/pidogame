...
?>
	<!-- <div class=" position-relative w-100px d-inline-block"> -->
		...
		<?php do_action('woocommerce_before_quantity_input_field'); ?>
			...
			<!-- <input readonly type="text" id="<?php echo esc_attr($input_id); ?>" name="<?php echo esc_attr($input_name); ?>" value="<?php echo esc_attr($input_value); ?>" data-plswb-min="<?php echo esc_attr($min_value); ?>" data-plswb-max="<?php echo esc_attr(0 < $max_value ? $max_value : ''); ?>" data-plswb-step="<?php echo esc_attr($step); ?>" class="plswb-qty"> -->
			<input readonly type="text" id="<?php echo esc_attr($input_id); ?>" name="<?php echo esc_attr($input_name); ?>" value="<?php echo esc_attr($input_value); ?>" data-plswb-min="1" data-plswb-max="10000000000000000000000000" data-plswb-step="<?php echo esc_attr($step); ?>" class="plswb-qty">
