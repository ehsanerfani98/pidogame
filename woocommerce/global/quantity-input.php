...
?>
	<div class=" position-relative w-100px d-inline-block">
		...
		<div class="wrap-input-number">
			...
			<input readonly type="text" id="<?php echo esc_attr($input_id); ?>" name="<?php echo esc_attr($input_name); ?>" value="<?php echo esc_attr($input_value); ?>" data-plswb-min="1" data-plswb-max="4" data-plswb-step="<?php echo esc_attr($step); ?>" class="plswb-quantity">
