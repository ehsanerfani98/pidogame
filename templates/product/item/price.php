...
<?php switch ($type):
    case 'simple':
        if ($product->is_in_stock()) : ?>
            <div role="button" data-bs-target="#kt_modal_product_buy" class="d-flex d-xl-flex border border-gray-300 border-dashed rounded p-6 mb-6 position-relative bg-hover-light-dark border-hover-primary">
        ...
        break;
    case 'variable': ?>
        <div class="scroll h-400px pe-5 py-4 px-2 card">
            ...
            foreach ($variations as $variation) :
                ...
                if ($variationProduct->is_in_stock()) : ?>
                    <div role="button" data-bs-target="#kt_modal_product_buy" <?php echo $variationData ?> class="d-flex d-xl-flex border border-gray-300 border-dashed rounded p-6 mb-6 position-relative bg-hover-light-dark border-hover-primary">
                        <!-- <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                            <a role="button" class="btn btn-sm btn-primary me-4">افزودن</a>
                            <div class="me-2">
                        ...
                        <div class="d-flex align-items-center flex-column justify-content-center mt-4 mt-md-2 mt-xl-0">
