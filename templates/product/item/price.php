...
<?php switch ($type):
    case 'simple':
        if ($product->is_in_stock()) : ?>
            <div role="button" data-bs-toggle="modal" data-bs-target="#kt_modal_product_buy" class="d-block d-xl-flex border border-gray-300 border-dashed rounded p-6 mb-6 position-relative bg-hover-light-dark border-hover-primary">
        ...
        <div class="scroll h-250px pe-5">
            ...
            foreach ($variations as $variation) :
                ...
                if ($variationProduct->is_in_stock()) : ?>
                    <div role="button" data-bs-toggle="modal" data-bs-target="#kt_modal_product_buy" <?php echo $variationData ?> class="d-block d-xl-flex border border-gray-300 border-dashed rounded p-6 mb-6 position-relative bg-hover-light-dark border-hover-primary">
                        <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                            <a role="button" class="btn btn-sm btn-primary me-4">افزودن</a>
                            <div class="me-2">
