                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-10">
                                        <label style="width: 100%;" for="exampleFormControlInput1" class="required form-label">تعداد درخواستی</label>
                                        <div class="position-relative w-100px d-inline-block" data-kt-dialer="true" data-kt-dialer-min="1" data-kt-dialer-max="" data-kt-dialer-step="1">
                                            ...
                                            <input name="" type="text" class="form-control form-control-solid border-0 text-center ss02 w-200px" readonly data-kt-dialer-control="input">
