                ...
                <?php foreach ($related as $productId) :
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card-xl-stretch">
                            ...
                            <div class="mt-5">
                                <a href="<?php echo get_permalink($productId) ?>" class="fs-6 text-dark fw-bolder text-hover-primary text-dark lh-base"><?php echo strip_tags(wp_trim_words(get_the_title($productId), 4, '...')) ?></a>
