            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div class="d-flex align-items-center flex-column">
                        <span onclick="setLikeComment()" style="cursor: pointer;" class="svg-icon svg-icon-muted"><svg xmlns="http://www.w3.org/2000/svg" class="h-30px w-30px" viewBox="0 0 24 24" fill="none">
