                                                                                    ...
                                                                                    <?php switch ($item['type_field']):
                                                                                        case 'email': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                <label for="email_<?= $variation['variation_id'] . $key ?>"><?= $item['title_field'] ?> <?= $item['required_field'] ? '<span style="color:red">(الزامی)</span>' : '' ?>
                                                                                                        <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="right" title="Tooltip on left" class="svg-icon svg-icon-muted svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
