                                                                                    ...
                                                                                    <?php switch ($item['type']):
                                                                                        case 'email': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> class="form-control" type="email" name="ext_email_<?= $variation['variation_id'] . $key ?>" id="ext_email_<?= $variation['variation_id'] . $key ?>">
                                                                                            </div>
                                                                                            <?php
                                                                                            break;
                                                                                            ?>
                                                                                        ...
                                                                                        case 'text': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> class="form-control" type="text" name="ext_text_<?= $variation['variation_id'] . $key ?>" id="ext_text_<?= $variation['variation_id'] . $key ?>">
                                                                                            </div>
                                                                                            <?php
                                                                                            break;
                                                                                            ?>
                                                                                        ...
                                                                                        case 'password': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> class="form-control" type="password" name="ext_password_<?= $variation['variation_id'] . $key ?>" id="ext_password_<?= $variation['variation_id'] . $key ?>">
                                                                                            </div>
                                                                                            <?php
                                                                                            break;
                                                                                            ?>
                                                                                        ...
                                                                                        case 'number': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <div class="position-relative w-100px d-inline-block" data-kt-dialer="true" data-kt-dialer-min="1" data-kt-dialer-max="" data-kt-dialer-step="1">
                                                                                                    ...
                                                                                                    <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" id="ext_number_<?= $variation['variation_id'] . $key ?>" name="ext_number_<?= $variation['variation_id'] . $key ?>" type="text" class="form-control form-control-solid border-0 text-center ss02 w-100px" readonly data-kt-dialer-control="input">
                                                                                        ...
                                                                                        case 'number_char': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> class="form-control" type="number" name="ext_number_char_<?= $variation['variation_id'] . $key ?>" id="ext_number_char_<?= $variation['variation_id'] . $key ?>">
                                                                                            </div>
                                                                                            <?php
                                                                                            break;
                                                                                            ?>
                                                                                        ...
                                                                                        case 'checkbox': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <input oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" value="<?= $item['price'] ?>" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> class="form-check-input" type="checkbox" name="ext_checkbox_<?= $variation['variation_id'] . $key ?>" id="ext_checkbox_<?= $variation['variation_id'] . $key ?>">
                                                                                        ...
                                                                                        case 'textarea': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                ...
                                                                                                <textarea oninvalid="this.setCustomValidity('پر کردن این فیلد الزامیست')" data-extra-title="<?= $item['title'] ?>" <?= $item['required'] ? 'required="required"' : '' ?> name="ext_textarea_<?= $variation['variation_id'] . $key ?>" class="form-control" id="ext_textarea_<?= $variation['variation_id'] . $key ?>" cols="30" rows="5"></textarea>
                                                                                            </div>
                                                                                            <?php
                                                                                            break;
                                                                                            ?>
