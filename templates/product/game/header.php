                                                                                    ...
                                                                                    <?php switch ($item['type_field']):
                                                                                        case 'email': ?>
                                                                                            <div class="form-group mb-4">
                                                                                                <label for="email_<?= $variation['variation_id'] . $key ?>"><?= $item['title_field'] ?> <?= $item['required_field'] ? '<span style="color:red">(الزامی)</span>' : '' ?><button type="button" class="btn btn-icon btn-success" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="right" title="Tooltip on left">
