        ...
        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
            ...
            <div data-kt-search-element="wrapper">
                ...
                <form data-kt-search-element="form" method="get" action="<?= home_url( 'shop/' ) ?>" class="w-100 position-relative mb-3" autocomplete="off">
                    ...
                    <!--end::Icon-->
                    <!--begin::Input-->
                    <input type="text" class="search-input form-control form-control-flush ps-10" name="s" id="search-product" value="" placeholder="جستجو در پیدو گیم" data-kt-search-element="input" />
                    <!--end::Input-->
                    <!--begin::Spinner-->
