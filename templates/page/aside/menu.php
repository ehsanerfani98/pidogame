        ...
        <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6 my-auto" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                ...
                <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link" href="/account">
                                    ...
                                    <span class="menu-title">پیشخوان کاربری</span>
                                </a>
                            </div>
                            <div class="menu-item">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="/account/orders">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">سفارش های من</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="/account/wallet">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">کیف پول من</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="/account/authentication">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link" href="/blog">
                                    ...
                                    <span class="menu-title">صفحه اصلی وبلاگ</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="/blog/post">
                                    ...
                                    <span class="menu-title">تک نوشته</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link" href="/blog/archive">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">بایگانی نوشته ها</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="/versions">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">راهنمای نسخه ها</span>
                        </a>
                    </div>
                    <div class="menu-item">
