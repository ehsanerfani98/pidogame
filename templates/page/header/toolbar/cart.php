...
<?php if ($options['opt-header-cart-switcher']) : ?>
    <div class="d-flex align-items-center ms-3 ms-lg-5">
        <a href="<?= home_url('cart') ?>" id="header-cart-btn" class="btn btn-icon bg-secondary bg-opacity-75 bg-hover-opacity-100 btn-color-gray-900 w-30px h-30px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
