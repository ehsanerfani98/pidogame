<div style="height: 66px;" id="kt_header" class="header align-items-stretch d-flex flex-column mb-10" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    <div class="header-container container-xxl d-flex align-items-center pt-4" style="border-bottom-left-radius: unset; border-bottom-right-radius: unset;">
