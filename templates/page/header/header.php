<div id="kt_header" class="header align-items-stretch d-none d-lg-flex d-xl-flex flex-column" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
