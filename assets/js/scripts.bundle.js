    ...
    return {
        ...
        setThemeMode: function (e, t) {
            ! function (e, t) {
                ...
                document.body.classList.add("page-loading"), "dark" === e ? Promise.all([n("plugins.bundle.rtl.css", "plugins.dark.bundle.rtl.css"), n("style.bundle.rtl.css", "style.dark.bundle.rtl.css")]).then((function () {
                    document.body.classList.add("dark-mode"), document.body.classList.remove("page-loading"), t instanceof Function && t()
                })).catch((function () { })) : "light" === e && Promise.all([n("plugins.dark.bundle.rtl.css", "plugins.bundle.rtl.css"), n("style.dark.bundle.rtl.css", "style.bundle.rtl.css")]).then((function () {
...
var KTLayoutSearch = function () {
    var e, t, n, i, r, o, a, l, s, u, d, c, m, f = function (e) {
        setTimeout((function () {
            var i = KTUtil.getRandomInt(1, 200);
            jQuery.ajax({
